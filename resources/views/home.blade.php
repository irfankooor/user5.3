...
@section('content')
  ...
  <div class="profile-cover">
    <div class="profile-cover-img" style="background-image: url('LTR/assets/images/teratai.jpg')"></div>
    <div class="media">
      ...
      <div class="media-body">
        ...
        @else
          <h1>{{ Auth::user()->name }}<small class="display-block">UX/UI designer</small></h1>
        @endif
      </div>
              ...
              <div class="timeline timeline-left content-group">
                <div class="timeline-container">
                  ...
                  <div class="timeline-row">
                    ...
                    <div class="panel panel-flat timeline-content">
                      <div class="panel-heading">
                        <h6 class="panel-title">Danau tratai</h6>
                        <div class="heading-elements">
                      ...
                      <div class="panel-body">
                        ...
                        <h6 class="content-group">
                          ...
                          Comment from <a href="#">Irfan kurniawan</a>:
                        </h6>
